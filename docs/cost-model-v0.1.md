...
- A cost-sensitive model handles most intent, extraction, and summarization work.
...
- OpenAI GPT-5.6 Luna text pricing: $1 per million input tokens and $6 per million output tokens.
...
- 12,000 model input tokens plus 2,000 output tokens on GPT-5.6 Luna: about $0.024.
...
Core technical cost is therefore approximately $0.045 per task before retries, stronger-model routing, observability, abuse, and failed automation. Use a planning range of **$0.05–$0.10 per meaningful task** until real measurements exist.

## Which component dominates cost?

There is no universal answer:

- AI inference dominates when prompts are long, outputs are large, or stronger models are used repeatedly.
- Search/data acquisition dominates when many fresh queries or merchant lookups are required.
- Remote-browser sessions, proxies, and anti-bot handling dominate when tasks require interactive website execution.
- Engineering, security, legal, and support dominate total company cash burn long before API spend becomes the largest company expense.

Track each successful task as separate search, model, browser, infrastructure, and failure/retry cost lines.

## Monthly operating scenarios

| Scenario | MAU | Tasks/month | Core vendor estimate | Safer monthly budget |
| --- | ---: | ---: | ---: | ---: |
| Private alpha | 100 | 500 | $25–$50 | $50–$150 |
| Early U.S. beta | 1,000 | 5,000 | $250–$500 | $300–$800 |
| Product validation | 10,000 | 50,000 | $2,500–$5,000 | $3,000–$7,500 |
| Early scale | 100,000 | 500,000 | $25,000–$50,000 | $30,000–$75,000 |
...
2. Cache normalized evidence only where provider terms allow it, without storing private user data.
3. Route most tasks to deterministic rules or cost-sensitive models.
